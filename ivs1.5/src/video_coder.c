...
void vfc_get_qcif_pal(vfc_dev, im_data)
...

  {
    ...
    static int limit1 = VFC_ESKIP_PAL >> 4;
    static int limit2 = QCIF_WIDTH >> 4;
    /*
    * Local register copy of the data port
    * improves performance
    */
...
void vfc_get_qcif_ntsc(vfc_dev, im_data)
...

  {
    ...
    static int grab_ioctl = CAPTRCMD;
    static int DROPP = VFC_YUV_WIDTH + 16;
    static int limit1 = VFC_OSKIP_NTSC >> 4;
    static int limit2 = QCIF_WIDTH >> 4;
    ...
    * IMAGE LAYER *
	...
	if(!ForceGobEncoding[NG-1]){
	  ...
	  for(MBA=1; MBA<34; MBA++){
	    ...
	    sum =  abs((int)new_image[lig_11][col_11] - 
		       (int)old[lig_11][col_11]);
	    sum += abs((int)new_image[lig_11][col_12] - 
		       (int)old[lig_11][col_12]);
	    sum += abs((int)new_image[lig_12][col_11] - 
		       (int)old[lig_12][col_11]);
	    sum += abs((int)new_image[lig_12][col_12] - 
	    ...
	    sum =  abs((int)new_image[lig_11][col_21] - 
		       (int)old[lig_11][col_21]);
	    sum += abs((int)new_image[lig_11][col_22] - 
		       (int)old[lig_11][col_22]);
	    sum += abs((int)new_image[lig_12][col_21] - 
		       (int)old[lig_12][col_21]);
	    sum += abs((int)new_image[lig_12][col_22] - 
	    ...
	    sum =  abs((int)new_image[lig_21][col_11] - 
		       (int)old[lig_21][col_11]);
	    sum += abs((int)new_image[lig_21][col_12] - 
		       (int)old[lig_21][col_12]);
	    sum += abs((int)new_image[lig_22][col_11] - 
		       (int)old[lig_22][col_11]);
	    sum += abs((int)new_image[lig_22][col_12] - 
	    ...
	    sum =  abs((int)new_image[lig_21][col_21] - 
		       (int)old[lig_21][col_21]);
	    sum += abs((int)new_image[lig_21][col_22] - 
		       (int)old[lig_21][col_22]);
	    sum += abs((int)new_image[lig_22][col_21] - 
		       (int)old[lig_22][col_21]);
	    sum += abs((int)new_image[lig_22][col_22] - 
